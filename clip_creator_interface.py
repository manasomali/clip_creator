...
def process_video(logger, input_path: str, output_path: str, start_time: str, end_time: str, banner_text: str, logo_path: str, zoom: float = 1.0, font_path: str = "assets/BebasNeue-Regular.ttf") -> None:
...
def generate_preview_frame(input_path: str, start_time: str, banner_text: str, logo_path: str, zoom: float = 1.0, font_path: str = "assets/BebasNeue-Regular.ttf"):
...
def main():
    ...
    while True:
        ...
        if event == "Preview":
            ...
            preview_data = generate_preview_frame(input_path, start_time, banner_text, logo_path, zoom, font_path)
        ...
        if event == "Process Video":
            ...
            try:
                ...
                process_video(logger, input_path, output_path, start_time, end_time, banner_text, logo_path, zoom, font_path)
